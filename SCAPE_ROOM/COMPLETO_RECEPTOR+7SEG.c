...
void main(void) {
    ...
    P1SEL |= BIT5 | BIT7;   // 11 PERIF�RICO SECUNDARIO
    P1DIR |= BIT5 | BIT7;   // P1.5 SALIDA P1.7
    P2DIR |= BIT0;   //P2.0: CS manejado manualmente
    // SALIDAS INVOLUCRADAS EN LA ELECCI�N DEL BIT //
    ...
    /*------ Configuraci�n de la USCI-A para modo SPI:----------*/
...
__interrupt void RUTINA_INTERRUPCI�N_SWITCH_ON(void)
{
    if(P2IN & SWITCH)
    {
        ENABLE = 1;
