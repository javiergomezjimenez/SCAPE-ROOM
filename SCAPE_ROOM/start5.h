...
#define		IR_PIN			(P1IN & BIT6)
#define		HIGH_1_LOW		P1IES |= BIT6
#define		LOW_1_HIGH		P1IES &= ~BIT6


#define		averageLogic0Pulse	0x200
#define		averageLogic1Pulse	0x645
...
#define		ONE		0x00FF08F7
#define		TWO		0x00FFC03F
#define		THR		0x00FF8074
